...
<MainLink href="https://sorarium.club/" label="sorarium.club" />
...
As an avid NBA fan, I found myself drawn to the game and acquired a few cards. However, as a passionate collector, I realized that the platform didn't quite offer the variety and customization I desired. **I wanted the ability to showcase my own unique collections and share them with the Sorare community.** That's why I created [Sorarium](https://sorarium.club/).
...
<LargeInner>![Sorarium homepage](/images/sorarium/collections.jpg)</LargeInner>
